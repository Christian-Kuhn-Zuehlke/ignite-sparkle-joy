...
CREATE TYPE public.app_role AS ENUM ('viewer', 'admin', 'msd_csm', 'msd_ma', 'system_admin');
...
BEGIN
  ...
  VALUES (
    ...
    COALESCE(NEW.raw_user_meta_data ->> 'company_id', 'GT'),
    COALESCE(NEW.raw_user_meta_data ->> 'company_name', 'GetSA')
  );
