-- Fix the handle_new_user trigger to handle edge cases with raw_user_meta_data
-- The issue is that raw_user_meta_data can sometimes be NULL or have invalid JSON
...
BEGIN
  -- Safely extract values from user metadata with NULL handling
  -- Use COALESCE to handle NULL raw_user_meta_data
